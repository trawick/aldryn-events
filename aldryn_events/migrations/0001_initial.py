    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail_link', models.URLField(default=b'', help_text='external link to details about this event', verbose_name='external link', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', djangocms_text_ckeditor.fields.HTMLField(default=b'', help_text='translated', verbose_name='short description', blank=True)),
                ('location', models.TextField(default=b'', verbose_name='location', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(default=b'en', max_length=32, choices=[(b'en', b'English')])),
                ('salutation', models.CharField(default=b'mrs', max_length=5, verbose_name='Anrede', choices=[(b'mrs', 'Frau'), (b'mr', 'Herr')])),
                ('company', models.CharField(default=b'', max_length=100, verbose_name='Company', blank=True)),
                ('first_name', models.CharField(max_length=100, verbose_name='Vorname')),
                ('last_name', models.CharField(max_length=100, verbose_name='Nachname')),
                ('address', models.TextField(default=b'', verbose_name='Adresse', blank=True)),
                ('address_zip', models.CharField(max_length=4, verbose_name='PLZ')),
                ('address_city', models.CharField(max_length=100, verbose_name='Ort')),
                ('phone', models.CharField(default=b'', max_length=20, verbose_name='Phone number', blank=True)),
                ('mobile', models.CharField(default=b'', max_length=20, verbose_name='Mobile number', blank=True)),
                ('email', models.EmailField(max_length=75, verbose_name='E-Mail')),
                ('message', models.TextField(default=b'', verbose_name='Message', blank=True)),
